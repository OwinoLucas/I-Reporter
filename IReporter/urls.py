...
urlpatterns=[
    ...
    url(r'^api/intervention-record/(?P<title>[A-Za-z]+)/$',InterventionList.as_view(), name='fetch-intervention-records'),
    ...
    url(r'^api/flag/(?P<title>[A-Za-z]+)/$',FlagList.as_view(), name='flag list records fetch'),
